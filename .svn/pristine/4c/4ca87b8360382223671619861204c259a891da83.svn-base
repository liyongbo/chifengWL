...
namespace Tools
{
    public class CacheRaw
    {
        ...
        {
            AddCacheItem(rawKey, value, CacheDuration, ETimeSpanModel.秒);
            //System.Web.Caching.Cache DataCache = HttpRuntime.Cache;
        ...
        public static List<ListItem> GetAllCacheList
        {
            get
            {
                ...
                {
                    ListItem md = new ListItem(CacheEnum.Key.ToString(), CacheEnum.Value.ToString());
                    lst.Add(md);
