...
namespace Configs.PicConfigs
{
    ...
    public class ConfigsInfo : IConfigInfo
    {
        ...
        private string _OpenMiniature; //是否开启缩图功能
        ...
        private int _MidiatureWidth2 = 160; //缩图的宽
        private int _MidiatureHeight2 = 160;  //缩图的高

        private int _MidiatureWidth3 = 160; //缩图的宽
        private int _MidiatureHeight3 = 160;  //缩图的高
        ...
        /// 中缩图的宽2
        /// </summary>
        public int MidiatureWidth2
        {
            get
            {
                return _MidiatureWidth2;
            }
            set
            {
                _MidiatureWidth2 = value;
            }
        }
        /// <summary>
        /// 中缩略图的高2
        /// </summary>
        public int MidiatureHeight2
        {
            get
            {
                return _MidiatureHeight2;
            }
            set
            {
                _MidiatureHeight2 = value;
            }
        }
        ...
        /// 中缩图的宽3
        /// </summary>
        public int MidiatureWidth3
        {
            get
            {
                return _MidiatureWidth3;
            }
            set
            {
                _MidiatureWidth3 = value;
            }
        }
        /// <summary>
        /// 中缩略图的高3
        /// </summary>
        public int MidiatureHeight3
        {
            get
            {
                return _MidiatureHeight3;
            }
            set
            {
                _MidiatureHeight3 = value;
            }
        }
