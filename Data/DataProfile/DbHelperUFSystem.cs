...
namespace Data.DataProfile
{
    ...
    /// 数据访问助手类
    /// </summary>
    public class DbHelperUFSystem : DbHelperBase
    {
        static public readonly DbHelperUFSystem Instance = new DbHelperUFSystem();
        /// <summary>
        /// 数据库连接字符串
        /// </summary>
        public override string ConnectionString()
        {
            if (string.IsNullOrEmpty(base.m_connectionstring))
            {
                ...
                base.m_connectionstring = Configs.BaseCinfigs.ConfigsControl.Instance.GetConnectionStringUFSystem();
