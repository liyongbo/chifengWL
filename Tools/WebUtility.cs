...
namespace Tools
{
    ...
    public class WebUtility
    {
        ...
        /// <returns></returns>
        public static string DoPost(string url, IDictionary<string, string> data, string encoding = "utf-8")
        {
            ...
            byte[] pageData = wc.UploadData(url, "POST", Encoding.Default.GetBytes(sb.ToString()));
