...
namespace Tools.Extension.Manager
{
    ...
    public class ExtensionManager
    {
        ...
        public static void ChangeStatus(string extension, bool enabled)
        {
            foreach (ManagedExtension x in _extensions)
            {
                ...
                {
                    x.Enabled = enabled;
                    DataStore.ExtensionSettings xs = new DataStore.ExtensionSettings(x.Name);
                    xs.SaveSettings(x);
                    SaveToCache();
        ...
        static ManagedExtension DataStoreExtension(string name)
        {
            ...
            Tools.DataStore.ExtensionSettings xs = new Tools.DataStore.ExtensionSettings(name);
        ...
        public static bool SaveToStorage()
        {
            ...
            {
                DataStore.ExtensionSettings xs = new DataStore.ExtensionSettings(ext.Name);
                xs.SaveSettings(ext);
            }
            return true;
        }
